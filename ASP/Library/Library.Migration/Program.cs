...
{
    private static readonly string _dbName = "Library_Asp";

    private static readonly string _connectionStringWithoutDatabase =
        "server=DESKTOP-5LA4REF;Trusted_Connection=True;Encrypt=false;TrustServerCertificate=true;";

    private static readonly string _connectionString =
        $"server=DESKTOP-5LA4REF;database={_dbName};Trusted_Connection=True;Encrypt=false;TrustServerCertificate=true;";
